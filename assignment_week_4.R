...
qplot(Global_Sales, Product, data=turtle_sales)
qplot(NA_Sales, Product, data=turtle_sales)
qplot(EU_Sales, Product, data=turtle_sales)
...
qplot(y=Platform, data=turtle_sales)
qplot(y=Product, data=turtle_sales)
qplot(y=NA_Sales, data=turtle_sales)
# Create a histogram
...
# Create a histogram
# First pass the x-variable, then specify the data source. 
qplot(Global_Sales, data=turtle_sales)
qplot(Global_Sales, bins=5, data=turtle_sales)

# Boxplot
qplot(NA_Sales, EU_Sales, data=turtle_sales, geom='boxplot')
